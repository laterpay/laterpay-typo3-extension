	...
	public static function getAdminMenu() {
		return array(
			'dashboard' => array(
				...
				'title'		=> tx_laterpay_helper_string::tr('Dashboard <sup class="lp_is-beta">beta</sup>', 'laterpay'),
				'submenu' 	=> array(
					'url'	=> '#',
					'title' => tx_laterpay_helper_string::tr('Time Passes', 'laterpay'),
					'id'	=> 'lp_js_switchDashboardView',
					'data'	=> array(
						'view'	=> 'time-passes',
						'label'	=> tx_laterpay_helper_string::tr('Standard KPIs', 'laterpay')
					),
				),
			),
			'pricing' => array(
				'url'	=> 'laterpay-pricing-tab',
				'title' => tx_laterpay_helper_string::tr('Pricing', 'laterpay')
			),
			'appearance' => array(
				'url' 	=> 'laterpay-appearance-tab',
				'title' => tx_laterpay_helper_string::tr('Appearance', 'laterpay')
			),
			'account' => array(
				'url' 	=> 'laterpay-account-tab',
				'title'	=> tx_laterpay_helper_string::tr('Account', 'laterpay')
			),
		);
	}
	...
	public static function formatNumber($number, $isMonetary = TRUE) {
		...
		if ($isMonetary) {
			...
			if ($number < 200) {
				...
				$formatted = number_format($number / 1000, 1) . tx_laterpay_helper_string::tr('k', 'laterpay');
